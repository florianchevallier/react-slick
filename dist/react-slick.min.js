          ...
          return (
            ...
            (r.adaptHeight = function() {
              if (r.props.adaptiveHeight && r.list) {
                ...
                r.list.style.height = (0, b.getHeight)(e) + "px";
              }
            }),
            (r.componentWillMount = function() {
              if (
                ...
                var e = (0, b.getOnDemandLazySlides)(c({}, r.props, r.state));
                e.length > 0 &&
            ...
            (r.updateState = function(e, t, n) {
              var i = (0, b.initializedState)(e);
              e = c({}, e, i, { slideIndex: i.currentSlide });
              var o = (0, b.getTrackLeft)(e);
              e = c({}, e, { left: o });
              var s = (0, b.getTrackCSS)(e);
              (t ||
            ...
            (r.ssrInit = function() {
              ...
              var f = d.default.Children.count(r.props.children),
                ...
                v = (0, b.getPreClones)(h) + (0, b.getPostClones)(h) + f,
                y = (100 / r.props.slidesToShow) * v,
                g = 100 / v,
                S =
                  (-g * ((0, b.getPreClones)(h) + r.state.currentSlide) * y) /
                  100;
            ...
            (r.progressiveLazyLoad = function() {
              for (
                ...
                n < r.state.slideCount + (0, b.getPostClones)(t);
                n++
              )
            ...
            (r.keyHandler = function(e) {
              var t = (0, b.keyHandler)(e, r.props.accessibility, r.props.rtl);
            ...
            (r.swipeStart = function(e) {
              ...
              var t = (0, b.swipeStart)(e, r.props.swipe, r.props.draggable);
              "" !== t && r.setState(t);
            }),
            ...
            (r.play = function() {
              ...
              if (r.props.rtl)
                ...
                if (!(0, b.canGoNext)(c({}, r.props, r.state))) return !1;
                e = r.state.currentSlide + r.props.slidesToScroll;
              }
              r.slideHandler(e);
            }),
      ...
      var i =
        ...
        (t.slideHandler = function(e) {
          ...
          if (r) {
            ...
            s < 0 ? (y = s + a) : s >= a && (y = s - a),
              ...
              (m = { animating: !0, currentSlide: y, lazyLoadedList: l }),
              (_ = { animating: !1 });
          } else
            (S = y),
              y < 0
        ...
        (t.swipeMove = function(e, t) {
          ...
          if (!n) {
            ...
            var L = Math.round(Math.sqrt(Math.pow(b.curY - b.startY, 2)));
            if (!a && !h && L > 10) return { scrolling: !0 };
            a && (b.swipeLength = L);
            var C = (l ? -1 : 1) * (b.curX > b.startX ? 1 : -1);
            ...
            return (
              ...
              Math.abs(b.curX - b.startX) < 0.8 * Math.abs(b.curY - b.startY)
                ? E
                : (b.swipeLength > 10 && ((E.swiping = !0), e.preventDefault()),
                  E)
            );
          }
        }),
        (t.swipeEnd = function(e, t) {
          ...
          if (o.swipeLength > h) {
            ...
            switch (v) {
              case "left":
              case "up":
                (m = u + b(t)), (S = d ? w(t, m) : m), (g.currentDirection = 0);
                break;
              case "right":
              case "down":
                (m = u - b(t)), (S = d ? w(t, m) : m), (g.currentDirection = 1);
                break;
              default:
                S = u;
            }
        ...
        m = (t.checkSpecKeys = function(e, t) {
        ...
        O = (t.getTrackLeft = function(e) {
          ...
          if (
            ...
            if (
              ...
              (b = o ? r + _(e) : r), (n = k && k.children[b]), (t = 0);
              for (var T = 0; T < b; T++)
